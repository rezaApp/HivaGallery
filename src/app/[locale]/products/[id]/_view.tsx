  ...
  return (
    <div className="mx-auto max-w-6xl space-y-12 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="bg-background/10 border-border/10 flex items-center rounded-lg border backdrop-blur-lg">
              <button
                type="button"
      ...
      <div className="space-y-6">
        <div className="bg-background/10 border-border/10 flex gap-1 rounded-xl border px-2 backdrop-blur-lg">
